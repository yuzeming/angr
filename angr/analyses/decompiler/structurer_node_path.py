...
from .structurer_nodes import BaseNode, SequenceNode, ConditionNode
...
class NodePath:
    ...
    def replace_node(self, old_node: BaseNode, new_node: BaseNode, parent_node: Optional[BaseNode]=None,
                     root_node: Optional[BaseNode]=None) -> bool:
